...
export default function RotatingBadge({ messages }: { messages: readonly string[] }) {
  ...
  return (
    <span
      className="inline-flex min-h-[2.25rem] items-center rounded border border-primary-200 bg-white px-3.5 py-1.5 text-[13px] font-medium text-primary-800 dark:border-primary-800 dark:bg-slate-900 dark:text-primary-300"
      aria-live="off"
    >
