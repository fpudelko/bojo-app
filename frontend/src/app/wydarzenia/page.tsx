...
export const metadata: Metadata = {
  title: 'Mecze i gry w Poznaniu — dołącz dziś',
  description:
    'Publiczne mecze piłki nożnej, koszykówki i siatkówki w Poznaniu. Zobacz, kto szuka graczy, i dołącz jednym kliknięciem.',
