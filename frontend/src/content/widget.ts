// Widget dla zarządców obiektów (roadmapa SEO/GEO, poz. 24 — F5). Copy osobno
// od JSX, wzorem reszty repo (AGENTS.md) — łatwiej trzymać krótkie, bez
// fraz zakazanych, i testować bez renderowania.
