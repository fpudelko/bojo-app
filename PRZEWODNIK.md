...
| **Grupy** (`/grupy`) | Stałe ekipy graczy (sport, miasto). Zakładanie, **link z zaproszeniem** (`/g/kod`), członkowie, mecze grupy, okładka. Edycja przez założyciela. **Ekipa jest prywatna:** kto do niej nie należy, widzi samą nazwę i przycisk „Poproś o dołączenie" — skład, rozmowa i statystyki dopiero po wejściu. **Do ekipy nie wchodzi się z linku:** kod i link zaproszenia składają prośbę (podpisaną imieniem zapraszającego), a rozpatruje ją założyciel albo członek zarządzający składem, w zakładce Skład. Mecze ekipy to osobna sprawa — w prywatnym meczu dalej zagra ktoś z zewnątrz, kto ma link | tak |
