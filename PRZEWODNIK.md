...
| **Grupy** (`/grupy`) | Stałe ekipy graczy (sport, miasto). Zakładanie, **link z zaproszeniem** (`/g/kod`), członkowie, mecze grupy, okładka. Edycja przez założyciela. **Ekipa jest prywatna:** kto do niej nie należy, widzi samą nazwę i przycisk „Poproś o dołączenie" — skład, mecze, rozmowa i statystyki dopiero po wejściu. Prośby rozpatruje założyciel albo członek zarządzający składem, w zakładce Skład | tak |
