...
- Drugi wyjątek: `frontend/src/app/api/turniej-media/` — media galerii/sponsorów
  turnieju leżą na Cloudflare R2, nie w Supabase Storage (migracja `160`, decyzja
  ...
  Szczegóły → [docs/domena.md](./docs/domena.md#turniej-media-zdjęcia-logotypy-sponsorów-na-cloudflare-r2-160).
...
(`group_posts`) i wiadomości prywatne (`dm_messages`, migracja `125`).
